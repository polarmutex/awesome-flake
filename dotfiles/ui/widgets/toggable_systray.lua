...
local function init_toggable_systray(args)
    ...
    -- left or right
    local toggle_side = props.toggle_side == 'right' and props.toggle_side or 'left'

    -- show icon
    local text_icon_show = type(props.text_icon_show) == 'string' and props.text_icon_show
        or (toggle_side == 'left' and ' ')
        or ' '

    -- hide icon
    local text_icon_hide = type(props.text_icon_hide) == 'string' and props.text_icon_hide
        or (toggle_side == 'left' and ' ')
        or ' '
